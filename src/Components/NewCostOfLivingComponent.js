...
let continue_button = {
  ...
  color: "#FFF",
  backgroundColor: "rgb(23, 145, 145)",
  borderColor: "rgb(23, 145, 145)",
  margin: "0 10px"
};
...
class NewCostOfLivingComponent extends React.Component {
  constructor(props) {
    ...
    this.changeCurrencyTypeAndValue = this.changeCurrencyTypeAndValue.bind(
      this
    );
  }
  ...
  changePosition() {
    let randomObject = this.state.listOfSalaries.salaries[
      Math.floor(Math.random() * this.state.listOfSalaries.salaries.length)
    ];
    let randomPosition = randomObject.job.title;
    let randomSalary = randomObject.salary_percentiles.percentile_50;
    ...
    let configuredSalary =
      (randomSalary / this.state.currencyResponseRates["USD"]) *
      this.state.currencyResponseRates[this.state.targetCurrency];
    let roundedConfiguredSalary = (Math.round(configuredSalary / 100) * 100)
      .toString()
      .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
              ...
              <div style={image_container} className="background-darken">
                {this.props.newCitySlug && (
                  <img
                    ...
                    style={{ width: "100%", opacity: "0.4", height: "30vh" }}
                    alt="City Banner"
                  />
                )}
                {!this.props.newCitySlug && (
                ...
                <div className="row">
                  {!this.isASpotAHomeCity() && (
                    <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 mobilePadding">
                      <div style={icon_index} id="icon-box">
                        <span>
                          <i className="fa fa-home fa fa-lg-modification" />
                        </span>
                      </div>
                  ...
                  {this.isASpotAHomeCity() && (
                    <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 mobilePadding">
                      ...
                      >
                        <span>
                          <i className="fa fa-strikethrough fa fa-spotahome-lg-modification" />
                        </span>
                      </div>
                      <p
                        onClick={this.openSpotAHomeDetails}
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 mobilePadding">
                    <div style={icon_index} id="icon-box">
                      <span>
                        <i className="fa fa-shopping-cart fa fa-lg-modification" />
                      </span>
                    </div>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 mobilePadding">
                    <div style={icon_index} id="icon-box">
                      <span>
                        <i className="fa fa-cutlery fa fa-lg-modification" />
                      </span>
                    </div>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 mobilePadding">
                    <div style={icon_index} id="icon-box">
                      <span>
                        <i className="fa fa-star fa fa-lg-modification" />
                      </span>
                    </div>
                    ...
                    {!purchasing_increase_format &&
                      this.props.purchasingPercentChange !== 0 && (
                        <p
                          style={percent_index_text}
                          className="tooltip-bottom"
                          data-tooltip={
              ...
              {this.props.newCitySlug && (
                <div style={final_container} className="container">
                  <div style={random_section}>
                    <p className="random-salary-text">
                      The median salary for a/an&nbsp;
                      <span
                        className="random-position tooltip-top"
                        onClick={this.changePosition}
                        data-tooltip="Click for another occupation!"
                      >
                        {" "}
                        {this.state.position}
                        <span style={super_script}>
                          {" "}
                          <i className="fa fa-user" aria-hidden="true" />{" "}
                        </span>
                        &nbsp;
                      </span>
                      in {this.props.newCity} is around{" "}
                      <span className="random-salary">
                        {this.state.targetCurrency} {this.state.salary}
                      </span>
                    </p>
                  </div>
                </div>
